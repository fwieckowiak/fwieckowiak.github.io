...
**PhD Student and R&D Engineer (CIFRE)**  
Luminess Lens – LIRIS Lyon  
...
- Definition of PhD research topic  
- Preliminary state of the art on mathematical and chemical expression recognition in patents  
...
- Analysis of scanning parameters influencing accuracy and speed  
- Study of robotic inspection pipelines for industrial applications  
...
- Presentation of results to R&D department  
...
## Programming
Python, MATLAB, HTML/CSS, PHP/SQL, LaTeX

## Software / Tools
VSCode, Zotero, Arduino, RoboDK, CAD

## Languages
- French: native  
- English: fluent (IELTS 7.5, C1 equivalent)  
...
- Machine learning: transfer learning using YOLOv5  
...
- Personalized session generator based on user profiles  
...
- Control interface implementation on Raspberry Pi  
...
- Embedded implementation using Arduino microcontroller  
- Prototype construction and engineering school competition presentation  
...
## ICDAR 2024 Doctoral Consortium (Sept 2024)
- Conference: ICDAR (A-ranked international conference)
- Contribution: presentation of PhD research proposal and preliminary results
- Mentored by 
...
- Total: ~15 hours of teaching  

---

# Interests

- Skateboarding (6 years: skateboard and longboard)  
- Coffee science and brewing  
- Role-playing games (game mastering, scenario writing)  
- Game development (game jams participation)  
- Music (drums, guitar, singing, keyboard)  
- Bikepacking trips and duathlon (running + cycling + running)
